...
if(WindowWidth < WindowHeight){
   ...
   let SetHeight = WindowHeight / 20;
let SetWidth = WindowWidth / 12;
let SetCircle = Math.round( SetHeight + SetWidth);
console.log(SetCircle)
night.style.height = `${SetHeight}px`
night.style.width = `${SetWidth}px`
night.style.borderRadius = `${SetCircle}px`
}
...
if(WindowHeight > WindowWidth){
   ...
   if(WindowHeight >= 765, WindowWidth >= 750){
      ...
      let SetNewHeight = WindowHeight / 2 ;
...
let text260 =  ['Taste:⭐⭐⭐', 'Service:⭐⭐⭐', 'Speed:⭐⭐⭐', 'White:⭐⭐⭐', 'Fame:⭐⭐⭐']     //['testttttttt', 'bbbbbbbbb', 'mmmmmmm', 'xxxxxxx'];
 ...
 let Bigscreen = ['Why Choose Us?',  'Fast Service: Get your favorite meals in minutes, perfect for on-the-go dining.',  'Quality Ingredients: We prioritize fresh, high-quality ingredients for every meal.',  'Variety: From hearty meals to lighter options, our menu caters to every taste.',  'Family-Friendly: Enjoy meal deals and combo options that everyone will love',]
